...
| [`venture-studio/`](venture-studio/) | **The upstream end of the studio** — the things you know, crossed with 33 product types and scored on six criteria into a ranked catalogue of ideas; then nine of its thirteen tabs stay shut until you have done six real marketplace checks by hand, because the app makes no network requests and will not invent the only evidence that anyone wants it. Past the gate: blueprint and four tiers, an ecosystem of nine rungs, 30/90/365-day catalogue plans with the point where upkeep eats the week, listings with every character limit enforced, a funnel, six licences, six SOPs, and a board of eight directors that can block. Exports as one 10,000-word dossier. |
