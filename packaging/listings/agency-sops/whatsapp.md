# The Agency Operations System — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product agency-sops --tier studio \
...
|---|---|
| Price | GHS 490 (Solo) |
| Image | `dist/mockups/agency-sops/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/agency-sops |
...
What you get:
• Stage — Hustler / Operator / Owner as a diagnostic, so you build the procedures for the stage…
...
2. Do the stage diagnostic first. Building Owner-stage systems while you are a Hustler…
...
The part people skip is Do the stage diagnostic first. Building Owner-stage systems while you are a Hustler wastes a fortnight.
