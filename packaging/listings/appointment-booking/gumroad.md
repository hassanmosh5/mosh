# AI Appointment Booking System — Gumroad listing
...
| URL / permalink | `appointment-booking` → https://moshdigitalstudios.gumroad.com/l/appointment-booking |
...
|---|---|---|
| Solo licence | $49 | `appointment-booking-solo.zip` |
| Studio licence ← set as default | $123 | `appointment-booking-studio.zip` |
| Agency licence | $245 | `appointment-booking-agency.zip` |
...
**Description** — 3070/12000 characters
...
- Cover: `dist/mockups/appointment-booking/cover.png` (already 1280×720)
- Thumbnail: `dist/mockups/appointment-booking/square.png` — crop to 600×600
- Extra gallery images: `dist/mockups/appointment-booking/gallery-*.png`
...
The full receipt text is in `dist/packages/appointment-booking/receipt-<tier>.txt`.
