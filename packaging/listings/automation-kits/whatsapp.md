# AI Automation Kits — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product automation-kits --tier studio \
...
**Item name** — 18/60 characters

```
AI Automation Kits
```

**Description** — 448/800 characters
...
|---|---|
| Price | GHS 740 (Solo) |
| Image | `dist/mockups/automation-kits/square.png` |
| Link | https://REPLACE-ME.example.com/products/automation-kits |
...
The highest-ceiling service in this whole field is written down everywhere as separate lists: an audit script, some templates, a proposal format, a pricing table, an ROI calculation.
...
The part people skip is Let the automations rank themselves; do not re-order them by what you enjoy building.
