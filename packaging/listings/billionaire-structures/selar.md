# Billionaire Structures Guide — Selar listing
...
| Link | `billionaire-structures` → https://selar.com/REPLACE-ME/billionaire-structures |
...
| Licence | GHS | NGN | USD |
|---|---|---|---|
| Solo licence | GHS 870 | NGN 107,000 | $69 |
| Studio licence (default) | GHS 2,170 | NGN 268,500 | $173 |
| Agency licence | GHS 4,320 | NGN 535,000 | $345 |
...
**Description** — 3172/8000 characters
...
- Main: `dist/mockups/billionaire-structures/square.png`
- Additional: `dist/mockups/billionaire-structures/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `billionaire-structures-studio.zip` as the
