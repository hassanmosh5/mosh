# CLEAR AI Board of Directors — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product board-of-directors --tier studio \
...
**Description** — 545/800 characters
...
|---|---|
| Price | GHS 620 (Solo) |
| Image | `dist/mockups/board-of-directors/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/board-of-directors |
...
The prompt 'act as a board of directors and advise me' is one of the most copied on the internet, and it fails in a specific way: fifteen enthusiastic paragraphs that agree with each other and with you. It looks like scrutiny; it functions as flattery.
...
2. Clear it, then fill in the Brief and the Numbers.
...
The part people skip is Clear it, then fill in the Brief and the Numbers. Rough figures are fine — tag them GUESSED and the board discounts its own confidence.
