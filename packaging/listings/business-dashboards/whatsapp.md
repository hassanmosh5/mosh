# Business Dashboard Templates — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product business-dashboards --tier studio \
...
**Description** — 474/800 characters
...
|---|---|
| Price | GHS 370 (Solo) |
| Image | `dist/mockups/business-dashboards/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/business-dashboards |
...
Most dashboard advice lists every metric that exists, which guarantees the dashboard is never built: tracking forty numbers is a bookkeeping project, and you have a business to run.
...
The part people skip is Fill in one week of real figures. Estimates are fine, mark them as such.
