# The Canva Template Library Builder — Selar listing
...
| Link | `canva-templates` → https://selar.com/REPLACE-ME/canva-templates |
| Category | Package & sell |

**Product name** — 34/80 characters
...
```
The build sheet you need before opening Canva
```
...
**Description** — 3011/8000 characters
...
- Main: `dist/mockups/canva-templates/square.png`
- Additional: `dist/mockups/canva-templates/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `canva-templates-studio.zip` as the
