# The Canva Template Library Builder — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product canva-templates --tier studio \
...
**Item name** — 34/60 characters

```
The Canva Template Library Builder
```

**Description** — 464/800 characters
...
|---|---|
| Price | GHS 490 (Solo) |
| Image | `dist/mockups/canva-templates/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/canva-templates |
...
Canva templates are among the highest-volume digital products there are, and the advice about them stops at 'pick a niche and make a pack'. What is missing is the document you need before opening Canva: which templates, at which pixel dimensions, in which colours, with which type pairing, laid out how.
...
The part people skip is Read the generated brand kit and change what does not suit you — it is a starting point.
