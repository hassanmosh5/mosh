# The Proposal & Contract Kit — Paystack Storefront listing
...
| Field | Value |
|---|---|
| Product | The Proposal & Contract Kit |
| Price (GHS) | GHS 1,540 |
...
**Description** — 421/500 characters
...
**Product image:** `dist/mockups/client-contracts/square.png`
...
```json
{
  "product_slug": "client-contracts",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `The Proposal & Contract Kit` or exactly `client-contracts`. The webhook matches on
