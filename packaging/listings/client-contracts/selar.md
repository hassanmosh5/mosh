# The Proposal & Contract Kit — Selar listing
...
| Link | `client-contracts` → https://selar.com/moshdigitalstudios/client-contracts |
...
**Description** — 3055/8000 characters
...
- Main: `dist/mockups/client-contracts/square.png`
- Additional: `dist/mockups/client-contracts/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `client-contracts-studio.zip` as the
