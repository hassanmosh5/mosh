# Course Creation Systems — Selar listing
...
| Link | `course-creation` → https://selar.com/moshdigitalstudios/course-creation |
| Category | Package & sell |

**Product name** — 23/80 characters
...
**Description** — 3063/8000 characters
...
- Main: `dist/mockups/course-creation/square.png`
- Additional: `dist/mockups/course-creation/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `course-creation-studio.zip` as the
