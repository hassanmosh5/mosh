# Digital Products Maker — Paystack Storefront listing
...
| Field | Value |
|---|---|
| Product | Digital Products Maker |
| Price (GHS) | GHS 1,230 |
...
**Product image:** `dist/mockups/digital-products/square.png`
...
```json
{
  "product_slug": "digital-products",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `Digital Products Maker` or exactly `digital-products`. The webhook matches on
