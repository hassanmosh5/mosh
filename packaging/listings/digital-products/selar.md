# Digital Products Maker — Selar listing
...
| Link | `digital-products` → https://selar.com/REPLACE-ME/digital-products |
| Category | Start & decide |

**Product name** — 22/80 characters
...
**Description** — 3484/8000 characters
...
- Main: `dist/mockups/digital-products/square.png`
- Additional: `dist/mockups/digital-products/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `digital-products-studio.zip` as the
