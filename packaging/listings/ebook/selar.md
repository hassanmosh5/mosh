# The AI Income Blueprint — Interactive Edition — Selar listing
...
| Licence | GHS | NGN | USD |
|---|---|---|---|
| Solo licence | GHS 240 | NGN 29,500 | $19 |
| Studio licence (default) | GHS 600 | NGN 74,500 | $48 |
| Agency licence | GHS 1,190 | NGN 147,500 | $95 |
...
**Description** — 2858/8000 characters
...
- Main: `dist/mockups/ebook/square.png`
- Additional: `dist/mockups/ebook/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `ebook-studio.zip` as the
