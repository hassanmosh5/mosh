# The AI Income Blueprint — Interactive Edition — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product ebook --tier studio \
...
**Item name** — 45/60 characters

```
The AI Income Blueprint — Interactive Edition
```

**Description** — 403/800 characters
...
|---|---|
| Price | GHS 240 (Solo) |
| Image | `dist/mockups/ebook/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/ebook |
...
The whole book, as something you work in.
...
GHS 240 — one payment, yours forever.
...
The part people skip is Read normally. Select any sentence to highlight it; click the highlight to add a note.
...
For client work you want the Studio licence — GHS 600 — which
