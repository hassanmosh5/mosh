# Store Setup Guides — Shopify & E-Commerce — Selar listing
...
| Link | `ecommerce-setup` → https://selar.com/moshdigitalstudios/ecommerce-setup |
...
**Description** — 3107/8000 characters
...
- Main: `dist/mockups/ecommerce-setup/square.png`
- Additional: `dist/mockups/ecommerce-setup/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `ecommerce-setup-studio.zip` as the
