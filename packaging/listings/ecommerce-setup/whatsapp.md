# Store Setup Guides — Shopify & E-Commerce — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product ecommerce-setup --tier studio \
...
|---|---|
| Price | GHS 370 (Solo) |
| Image | `dist/mockups/ecommerce-setup/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/ecommerce-setup |
...
When to leave the marketplace, and how.

Every step before this one is documented in detail — validation, listing SEO, pricing bands, launch plans — and then the last step, owning your store, is a single sentence: do it once you are earning consistently. That leaves the two questions that matter unanswered.
...
The part people skip is Put your real monthly sales and fee percentage into the break-even calculator.
