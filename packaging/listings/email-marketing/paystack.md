# Email Marketing Automation — Paystack Storefront listing
...
**Product name** — 26/100 characters

```
Email Marketing Automation
```

**Description** — 462/500 characters
...
**Product image:** `dist/mockups/email-marketing/square.png`
...
```json
{
  "product_slug": "email-marketing",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `Email Marketing Automation` or exactly `email-marketing`. The webhook matches on
