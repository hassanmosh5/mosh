# Email Marketing Automation — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product email-marketing --tier studio \
...
**Item name** — 26/60 characters

```
Email Marketing Automation
```

**Description** — 465/800 characters
...
|---|---|
| Price | GHS 490 (Solo) |
| Image | `dist/mockups/email-marketing/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/email-marketing |
...
The part people skip is Read the subscriber value figure before you plan any acquisition spend.
