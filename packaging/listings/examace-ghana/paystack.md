# ExamAce Ghana — EdTech Site Template — Paystack Storefront listing
...
| Field | Value |
|---|---|
| Product | ExamAce Ghana — EdTech Site Template |
| Price (GHS) | GHS 1,230 |
| Price (NGN) | NGN 152,000 |
| Quantity | Unlimited |
| Success message | See below |

**Product name** — 36/100 characters
...
**Product image:** `dist/mockups/examace-ghana/square.png`
...
```json
{
  "product_slug": "examace-ghana",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `ExamAce Ghana — EdTech Site Template` or exactly `examace-ghana`. The webhook matches on
