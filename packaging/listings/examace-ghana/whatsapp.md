# ExamAce Ghana — EdTech Site Template — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product examace-ghana --tier studio \
...
**Item name** — 36/60 characters

```
ExamAce Ghana — EdTech Site Template
```

**Description** — 444/800 characters
...
|---|---|
| Price | GHS 490 (Solo) |
| Image | `dist/mockups/examace-ghana/square.png` |
| Link | https://REPLACE-ME.example.com/products/examace-ghana |
...
• Zero images — every icon is an inline SVG symbol, the hero is a CSS phone mock, the favicon is…
...
The part people skip is Replace the brand, subjects and pricing with yours — everything is plain HTML.
