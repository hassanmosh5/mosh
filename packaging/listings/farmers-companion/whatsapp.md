# Farmer's Companion — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product farmers-companion --tier studio \
...
**Description** — 442/800 characters
...
|---|---|
| Price | GHS 490 (Solo) |
| Image | `dist/mockups/farmers-companion/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/farmers-companion |
...
Every farm-planning spreadsheet asks for a yield, and nobody can honestly supply one. Worse, most of them rank crops by margin per hectare — which is the right ranking only if land is what you run out of, and land almost never is.
...
2. Let it derive the yield. It starts at the crop ceiling and works down from what it can…
...
The part people skip is Let it derive the yield. It starts at the crop ceiling and works down from what it can check.
