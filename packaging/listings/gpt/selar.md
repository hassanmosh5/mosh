# Digital Product Studio — custom GPT — Selar listing
...
| Link | `gpt` → https://selar.com/moshdigitalstudios/gpt |
| Category | Start & decide |

**Product name** — 35/80 characters

```
Digital Product Studio — custom GPT
```

**Short description** — 40/160 characters
...
| Licence | GHS | NGN | USD |
|---|---|---|---|
| Solo licence | GHS 300 | NGN 37,500 | $24 |
| Studio licence (default) | GHS 750 | NGN 93,000 | $60 |
| Agency licence | GHS 1,500 | NGN 186,000 | $120 |
...
**Description** — 3085/8000 characters
...
- Main: `dist/mockups/gpt/square.png`
- Additional: `dist/mockups/gpt/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `gpt-studio.zip` as the
