# Invoice & Payment Automation — Paystack Storefront listing
...
| Field | Value |
|---|---|
| Product | Invoice & Payment Automation |
| Price (GHS) | GHS 1,230 |
...
**Description** — 484/500 characters
...
**Product image:** `dist/mockups/invoice-automation/square.png`
...
```json
{
  "product_slug": "invoice-automation",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `Invoice & Payment Automation` or exactly `invoice-automation`. The webhook matches on
