# AI Income Launch Kit — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product launch-kit --tier studio \
...
**Item name** — 20/60 characters

```
AI Income Launch Kit
```

**Description** — 471/800 characters
...
|---|---|
| Price | GHS 370 (Solo) |
| Image | `dist/mockups/launch-kit/square.png` |
| Link | https://REPLACE-ME.example.com/products/launch-kit |
...
The reason most AI side incomes never start is not laziness and not the market — it is that the first decision never gets made. Seven plausible streams, no way to compare them against your own hours, skills and cash, so you research a fourth one instead.

What you get:
• Fit Matrix — score yourself on five dimensions and get all seven income streams ranked, with a…
• 7-Day Validation Sprint — one action a day, each with the question it answers and the output it…
• Commitment Statement — the fill-in template, rendered as a signed document you can print and…
• 30-Day Launch Plan — all thirty days with real tasks, time estimates and weekly milestone…

GHS 370 — one payment, yours forever.
...
2. Do the Fit Matrix first — five sliders, about six minutes.
3. Run the 7-Day Sprint on your top stream. One action per day; write the output in the box,…
...
The part people skip is Do the Fit Matrix first — five sliders, about six minutes. Read the ranking before you argue with it.
...
For client work you want the Studio licence — GHS 920 — which
