# Local Business Website Studio — Paystack Storefront listing
...
| Field | Value |
|---|---|
| Product | Local Business Website Studio |
| Price (GHS) | GHS 1,540 |
...
**Description** — 420/500 characters
...
**Product image:** `dist/mockups/local-business-templates/square.png`
...
```json
{
  "product_slug": "local-business-templates",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `Local Business Website Studio` or exactly `local-business-templates`. The webhook matches on
