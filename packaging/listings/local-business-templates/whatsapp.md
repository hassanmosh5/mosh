# Local Business Website Studio — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product local-business-templates --tier studio \
...
**Description** — 423/800 characters
...
|---|---|
| Price | GHS 620 (Solo) |
| Image | `dist/mockups/local-business-templates/square.png` |
| Link | https://REPLACE-ME.example.com/products/local-business-templates |
...
The part people skip is Paste the client's real name, phone number, services and areas over the placeholders.
