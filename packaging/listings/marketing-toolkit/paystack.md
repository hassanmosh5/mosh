# The Digital Marketing Toolkits — Paystack Storefront listing
...
| Field | Value |
|---|---|
| Product | The Digital Marketing Toolkits |
| Price (GHS) | GHS 1,540 |
| Price (NGN) | NGN 191,000 |
| Quantity | Unlimited |
| Success message | See below |

**Product name** — 30/100 characters
...
**Product image:** `dist/mockups/marketing-toolkit/square.png`
...
```json
{
  "product_slug": "marketing-toolkit",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `The Digital Marketing Toolkits` or exactly `marketing-toolkit`. The webhook matches on
