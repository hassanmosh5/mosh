# The Digital Marketing Toolkits — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product marketing-toolkit --tier studio \
...
**Item name** — 30/60 characters

```
The Digital Marketing Toolkits
```

**Description** — 475/800 characters
...
|---|---|
| Price | GHS 620 (Solo) |
| Image | `dist/mockups/marketing-toolkit/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/marketing-toolkit |
...
The operational knowledge for running a marketing service exists — a method for finding prospects, scripts for approaching them, a workflow with real time estimates, priced packages, retention behaviours.
...
The part people skip is Generate outreach for the top three; send it the same day.
