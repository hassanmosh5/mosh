# Meta Ads & Pixel Blueprints — Selar listing
...
| Link | `meta-ads` → https://selar.com/moshdigitalstudios/meta-ads |
...
**Short description** — 42/160 characters
...
**Description** — 3049/8000 characters
...
- Main: `dist/mockups/meta-ads/square.png`
- Additional: `dist/mockups/meta-ads/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `meta-ads-studio.zip` as the
