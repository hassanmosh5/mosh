# Meta Ads & Pixel Blueprints — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product meta-ads --tier studio \
...
**Description** — 450/800 characters
...
|---|---|
| Price | GHS 620 (Solo) |
| Image | `dist/mockups/meta-ads/square.png` |
| Link | https://REPLACE-ME.example.com/products/meta-ads |
...
Whether your budget can work at all, first.

Paid traffic fails at small budgets in a way nobody warns about: the campaign never gathers enough conversion events to leave the learning phase, so the algorithm optimises on noise and the money goes out in a straight line.
...
2. Read the learning-phase verdict before designing anything.
...
The part people skip is Read the learning-phase verdict before designing anything. If it says the budget is too small, that is the most valuable output here.
