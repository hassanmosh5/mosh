# E-Commerce Order Automation — Gumroad listing
...
| URL / permalink | `order-automation` → https://moshdigitalstudios.gumroad.com/l/order-automation |
...
|---|---|---|
| Solo licence | $49 | `order-automation-solo.zip` |
| Studio licence ← set as default | $123 | `order-automation-studio.zip` |
| Agency licence | $245 | `order-automation-agency.zip` |
...
**Description** — 2917/12000 characters
...
- Cover: `dist/mockups/order-automation/cover.png` (already 1280×720)
- Thumbnail: `dist/mockups/order-automation/square.png` — crop to 600×600
- Extra gallery images: `dist/mockups/order-automation/gallery-*.png`
...
The full receipt text is in `dist/packages/order-automation/receipt-<tier>.txt`.
