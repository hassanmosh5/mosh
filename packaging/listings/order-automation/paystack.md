# E-Commerce Order Automation — Paystack Storefront listing
...
| Field | Value |
|---|---|
| Product | E-Commerce Order Automation |
| Price (GHS) | GHS 1,540 |
...
**Product image:** `dist/mockups/order-automation/square.png`
...
```json
{
  "product_slug": "order-automation",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `E-Commerce Order Automation` or exactly `order-automation`. The webhook matches on
