# MOSH Packaging Agent — Selar listing
...
| Link | `packaging-agent` → https://selar.com/moshdigitalstudios/packaging-agent |
...
**Short description** — 37/160 characters
...
**Description** — 3278/8000 characters
...
- Main: `dist/mockups/packaging-agent/square.png`
- Additional: `dist/mockups/packaging-agent/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `packaging-agent-studio.zip` as the
