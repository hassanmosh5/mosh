# MOSH Packaging Agent — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product packaging-agent --tier studio \
...
**Description** — 495/800 characters
...
|---|---|
| Price | GHS 870 (Solo) |
| Image | `dist/mockups/packaging-agent/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/packaging-agent |
...
Ten fields in, a sellable product out.

An AI output is not a product. The gap between the two is not creativity, it is a list of specific artefacts: a licence saying what a buyer may resell, a price that sits somewhere defensible, a file list published before payment, a paragraph naming what the thing cannot do.
...
2. Read the monetisation score before generating. A low score is information, not an…
...
The part people skip is Read the monetisation score before generating. A low score is information, not an obstacle.
...
For client work you want the Studio licence — GHS 2,170 — which
