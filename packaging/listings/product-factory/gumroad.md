# MOSH Product Factory — Gumroad listing
...
| URL / permalink | `product-factory` → https://moshdigitalstudios.gumroad.com/l/product-factory |
...
**Summary (shows under the title)** — 172/255 characters
...
|---|---|---|
| Solo licence | $59 | `product-factory-solo.zip` |
| Studio licence ← set as default | $148 | `product-factory-studio.zip` |
| Agency licence | $295 | `product-factory-agency.zip` |
...
**Description** — 3028/12000 characters
...
- Cover: `dist/mockups/product-factory/cover.png` (already 1280×720)
- Thumbnail: `dist/mockups/product-factory/square.png` — crop to 600×600
- Extra gallery images: `dist/mockups/product-factory/gallery-*.png`
...
The full receipt text is in `dist/packages/product-factory/receipt-<tier>.txt`.
