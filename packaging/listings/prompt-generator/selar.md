# The Wealth Ideas Prompt Generator — Selar listing
...
| Link | `prompt-generator` → https://selar.com/REPLACE-ME/prompt-generator |
| Category | Package & sell |

**Product name** — 33/80 characters
...
```
99,000 prompts from one matrix, packaged for sale
```
...
**Description** — 3009/8000 characters
...
- Main: `dist/mockups/prompt-generator/square.png`
- Additional: `dist/mockups/prompt-generator/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `prompt-generator-studio.zip` as the
