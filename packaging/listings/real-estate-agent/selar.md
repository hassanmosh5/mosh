# AI Real Estate Agent — Selar listing
...
| Link | `real-estate-agent` → https://selar.com/moshdigitalstudios/real-estate-agent |
...
```
Leads are not lost to competitors, but to Tuesday
```
...
**Description** — 3031/8000 characters
...
- Main: `dist/mockups/real-estate-agent/square.png`
- Additional: `dist/mockups/real-estate-agent/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `real-estate-agent-studio.zip` as the
