# Real Estate Calculator — Selar listing
...
| Link | `real-estate-calculator` → https://selar.com/REPLACE-ME/real-estate-calculator |
...
**Short description** — 25/160 characters
...
**Description** — 3061/8000 characters
...
- Main: `dist/mockups/real-estate-calculator/square.png`
- Additional: `dist/mockups/real-estate-calculator/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `real-estate-calculator-studio.zip` as the
