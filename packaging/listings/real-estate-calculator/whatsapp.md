# Real Estate Calculator — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product real-estate-calculator --tier studio \
...
**Description** — 485/800 characters
...
|---|---|
| Price | GHS 620 (Solo) |
| Image | `dist/mockups/real-estate-calculator/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/real-estate-calculator |
...
Rent divided by price takes two seconds and answers nothing. It is missing the purchase tax, the void, the capital reserve, the lender's stress test, the finance-cost restriction and the day the fixed rate ends.
...
The part people skip is Set the lender's stress rate, not the pay rate.
