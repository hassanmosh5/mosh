# SEO & Content Marketing Systems — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product seo-content --tier studio \
...
**Description** — 493/800 characters
...
|---|---|
| Price | GHS 620 (Solo) |
| Image | `dist/mockups/seo-content/square.png` |
| Link | https://REPLACE-ME.example.com/products/seo-content |
...
1. Open index.html and enter what a conversion is worth to you.
...
The part people skip is Score your candidate keywords; ignore the volume column on its own.
