# Social Media Content Automation — Paystack Storefront listing
...
| Field | Value |
|---|---|
| Product | Social Media Content Automation |
| Price (GHS) | GHS 1,230 |
...
**Description** — 408/500 characters
...
**Product image:** `dist/mockups/social-automation/square.png`
...
```json
{
  "product_slug": "social-automation",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `Social Media Content Automation` or exactly `social-automation`. The webhook matches on
