# Social Media Content Automation — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product social-automation --tier studio \
...
**Item name** — 31/60 characters

```
Social Media Content Automation
```

**Description** — 411/800 characters
...
|---|---|
| Price | GHS 490 (Solo) |
| Image | `dist/mockups/social-automation/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/social-automation |
...
A content plan is allowed to contain three contradictory numbers: what you promised to post, what your source material can actually yield, and how many hours exist.

What you get:
• The three-number reconciliation: promise, yield, hours
...
1. Open index.html and enter your posting promise, your source material and your real weekly…
2. Read the shortfall. Fix it by lowering the promise or raising the input — not by…
...
The part people skip is Read the shortfall. Fix it by lowering the promise or raising the input — not by resolving to try harder.
