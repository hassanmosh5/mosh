# AI Customer Support Agent — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product support-agent --tier studio \
...
**Item name** — 25/60 characters

```
AI Customer Support Agent
```

**Description** — 478/800 characters
...
|---|---|
| Price | GHS 620 (Solo) |
| Image | `dist/mockups/support-agent/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/support-agent |
...
Support agents are sold on containment: the share of conversations the bot closes. Containment counts the tickets it answers and ignores the ones it answers wrongly, which do not cost zero — the customer comes back crosser, a person untangles it, and some of them leave.
...
The part people skip is Work through the intents. The ones it advises against automating are the point.
