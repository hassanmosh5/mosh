# CLEAR AI Digital Product Venture Studio — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product venture-studio --tier studio \
...
**Item name** — 39/60 characters

```
CLEAR AI Digital Product Venture Studio
```

**Description** — 508/800 characters
...
|---|---|
| Price | GHS 990 (Solo) |
| Image | `dist/mockups/venture-studio/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/venture-studio |
...
Most people with something worth selling make the same three mistakes in the same order: they pick the product type first, they validate after building, and they think in single products instead of catalogues.

What you get:
• Assets and Opportunities — three things you know × 33 product types, scored on six criteria…
...
GHS 990 — one payment, yours forever.
...
1. Open index.html. A worked example is loaded so you can see a finished dossier before…
2. Clear it, then enter three things you genuinely know.
3. Read the ranked opportunities, including the low scores.
...
The part people skip is Clear it, then enter three things you genuinely know. Be specific — 'payroll for Ghanaian SMEs' beats 'business'.
...
For client work you want the Studio licence — GHS 2,480 — which
