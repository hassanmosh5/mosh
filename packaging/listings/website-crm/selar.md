# AI Website + CRM Automation — Selar listing
...
| Link | `website-crm` → https://selar.com/REPLACE-ME/website-crm |
...
**Short description** — 62/160 characters

```
At thirty enquiries a month, most of the build list is a hobby
```
...
**Description** — 2932/8000 characters
...
- Main: `dist/mockups/website-crm/square.png`
- Additional: `dist/mockups/website-crm/cover.png`, `gallery-*.png`

## Delivery

Selar delivers the file itself. Upload `website-crm-studio.zip` as the
