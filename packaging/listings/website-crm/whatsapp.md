# AI Website + CRM Automation — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product website-crm --tier studio \
...
**Description** — 484/800 characters
...
|---|---|
| Price | GHS 740 (Solo) |
| Image | `dist/mockups/website-crm/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/website-crm |
...
Website and CRM automation is the most saleable service there is, and it is where the largest amount of confident nonsense lives: build lists of forty automations, tool stacks priced like an enterprise, and payback claims nobody has ever checked.
...
GHS 740 — one payment, yours forever.
...
1. Open index.html and pick your business model, then enter monthly enquiry volume and your…
...
The part people skip is Read the 'do not build yet' list carefully — it is usually most of the list.
...
For client work you want the Studio licence — GHS 1,850 — which
