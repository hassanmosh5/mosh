# AI Website Prompt Kit — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product website-prompts --tier studio \
...
**Item name** — 21/60 characters

```
AI Website Prompt Kit
```

**Description** — 469/800 characters
...
|---|---|
| Price | GHS 370 (Solo) |
| Image | `dist/mockups/website-prompts/square.png` |
| Link | https://REPLACE-ME.example.com/products/website-prompts |
...
An AI website builder never asks for what it was not given. Say 'build me a site for my roofing business' and it does not stop — it produces one, with an invented brand, invented services, invented testimonials, a stack it chose silently, and a purple gradient hero.
...
The part people skip is Fill in the content inventory honestly — what does not exist has to be written by someone.
