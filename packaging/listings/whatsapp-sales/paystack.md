# WhatsApp AI Sales Assistant — Paystack Storefront listing
...
| Field | Value |
|---|---|
| Product | WhatsApp AI Sales Assistant |
| Price (GHS) | GHS 1,540 |
...
**Description** — 442/500 characters
...
**Product image:** `dist/mockups/whatsapp-sales/square.png`
...
```json
{
  "product_slug": "whatsapp-sales",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `WhatsApp AI Sales Assistant` or exactly `whatsapp-sales`. The webhook matches on
