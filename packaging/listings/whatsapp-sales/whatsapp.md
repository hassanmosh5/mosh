# WhatsApp AI Sales Assistant — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product whatsapp-sales --tier studio \
...
**Description** — 445/800 characters
...
|---|---|
| Price | GHS 620 (Solo) |
| Image | `dist/mockups/whatsapp-sales/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/whatsapp-sales |
...
On WhatsApp the selling is the easy half. The half that sinks these builds is a set of platform rules: what a template may say, when a session is open, what a follow-up is allowed to be once the 24-hour window closes, and what each conversation category costs.
...
The part people skip is Draft templates in the checker; fix what it flags before submitting to Meta.
