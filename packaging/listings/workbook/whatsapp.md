# Star Explorers — Interactive Workbook for Kids — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product workbook --tier studio \
...
**Item name** — 46/60 characters

```
Star Explorers — Interactive Workbook for Kids
```

**Description** — 425/800 characters
...
GHS 180 — one payment, yours forever.
...
The part people skip is Set the difficulty on the home screen; it applies everywhere.
...
For client work you want the Studio licence — GHS 440 — which
