# The Faceless YouTube Toolkits — Paystack Storefront listing
...
| Field | Value |
|---|---|
| Product | The Faceless YouTube Toolkits |
| Price (GHS) | GHS 1,230 |
...
**Product image:** `dist/mockups/youtube-toolkit/square.png`
...
```json
{
  "product_slug": "youtube-toolkit",
  "tier": "studio"
}
```

If you cannot set metadata on a storefront product, name the Paystack product
**exactly** `The Faceless YouTube Toolkits` or exactly `youtube-toolkit`. The webhook matches on
