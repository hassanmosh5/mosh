# The Faceless YouTube Toolkits — WhatsApp Business listing
...
```bash
npm run pkg:grant -- --product youtube-toolkit --tier studio \
...
**Item name** — 29/60 characters

```
The Faceless YouTube Toolkits
```

**Description** — 468/800 characters
...
|---|---|
| Price | GHS 490 (Solo) |
| Image | `dist/mockups/youtube-toolkit/square.png` |
| Link | https://paystack.shop/mosh-digital-studios/products/youtube-toolkit |
...
The part people skip is Run the production workflow for your first video and time each step.
